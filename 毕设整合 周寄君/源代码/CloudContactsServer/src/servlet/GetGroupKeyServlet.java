...
/**
 * Servlet implementation class GetGroupKeyServlet
 */
@WebServlet("/GetGroupKeyServlet")
public class GetGroupKeyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result;
		if(me!=null){
			result = cs.getGroupKey(groupid,me.getString("contactId"));
		}else{
